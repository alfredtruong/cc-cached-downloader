...
for index,execution_id in execution_ids.items():
  ...
  df.to_pickle(Path(r'C:\Users\alfred\Desktop\D_DRIVE\data') / f'athena/{index}.pkl')
...
# filter results
########################################
df = pd.read_pickle(Path(r'C:\Users\alfred\Desktop\D_DRIVE\data') / f'athena/{index}.pkl')
...
s = f'https://us-east-1.console.aws.amazon.com/s3/object/omgbananarepublic?region=us-east-1&bucketType=general&prefix=e8732d47-a592-4dca-ac57-9e79f3b00de4.csv'
s = f'https://us-east-1.console.aws.amazon.com/s3/object/omgbananarepublic?region=us-east-1&bucketType=general&prefix={execution_id}.csv'
...
df = pd.read_csv(fr"C:\Users\alfred\Downloads\{execution_ids['2024-22']}.csv")
